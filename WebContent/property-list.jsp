...
<center>
  <div style="max-width: 1000px; background-color: #b69b00; margin-top: 80px; margin-bottom: 80px; padding: 100px;">
    <h1 style="margin-bottom: 20px; color: white;">Find Your Dream Land</h1>

    <form action="/real-estate-management-system/search" method="get" class="form-inline my-2 my-lg-0">
      <input class="form-control w-100 mr-sm-2" type="search" placeholder="Search by Address" name="address" aria-label="Search">
      <button class="btn btn-outline-light btn-block my-2 my-sm-0" type="submit">Search</button>
    </form>
  </div>
</center>
